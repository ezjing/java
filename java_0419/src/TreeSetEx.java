...
public class TreeSetEx {
    public static void main(String[] args) {
        ...
        // first() : 최소값 출력
        // last() : 최대값 출력
        // higher() : 입력값보다 큰 데이터 중 최소값 출력, 없으면 null
        // lower() : 입력값보다 작은 데이터 중 최대값 출력, 없으면 null
        // iterator() : 트리셋의 데이터를 반복자 컬렉션으로 출력
        // floor(데이터) : 입력값과 같거나 작은 데이터 중 최대 값을 출력
        ...
        // subSet(시작, 종료, 포함여부) : 시작 범위와 종료 범위 사이의 데이터를 출력, 해당 객체를 포함할지 여부 지정
        ...
        while (!scores.isEmpty()) {
            ...
            System.out.println(score + "(남은 객체 수 : " + scores.size() + ")");    // pollFirst가 삭제까지 해주기 때문에 객체가 남지 않음
        }
    }
}
